...
@section('title','PERFECTALL/Search')
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12 py-5">
      	 @if(isset($products[0]))
        <div class="section-tile custom-row">
           <h5>Found your search product ({{count($products)}})</h5>
        </div>
        @endif
      </div>
    </div>
        ...
        <div class="product-item">
          ...
          <div class="hover-content">
            <div class="hover-icon">
              ...
              onclick="home_add_to_cart('{{$product->id}}','{{$search_products_attrs[$product->id][0]->size}}','{{$search_products_attrs[$product->id][0]->color}}')"
              >
